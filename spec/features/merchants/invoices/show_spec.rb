...
RSpec.describe 'Merchant Invoice Show Page' do
  describe "Merchant Invoice Show Page" do
    ...
    it 'shows the total revenue, and the total discounted revenue for invoice' do
      ...
      expect(page).to have_content("Total Revenue: 58000")
      expect(page).to have_content("Total Discounted Revenue: 54000")
    end

    it 'shows the link to the applied discount if any' do
      @bd_1 = @merch1.bulk_discounts.create!(percentage_discount: 10.00, quantity_threshold: 15)
      @bd_2 = @merch1.bulk_discounts.create!(percentage_discount: 20.00, quantity_threshold: 25)
      visit "/merchants/#{@merch1.id}/invoices/#{@invoice1.id}"
